                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <p class="page-subtitle">
                                    Network structure and hierarchy | Round {{ $round }} | Members: {{ $tree['member_count'] }}/30 (4 levels max)
                    ...
                    <div class="tree-container">
                        ...
                        <div class="tree-level">
                            ...
                            <div class="alert alert-info mt-3">
                                <i class="fas fa-info-circle me-2"></i>
                                <strong>Note:</strong> Level 4 members can have their own trees. Click on them to view their separate tree structure.
                            </div>
                        </div>
                        @endif
