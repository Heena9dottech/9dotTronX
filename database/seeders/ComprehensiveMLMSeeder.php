...
class ComprehensiveMLMSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create 200 users with tree repetition logic
        $this->create200UsersWithTreeRepetition($admin, $levelPlans);

        $this->command->info('✅ Comprehensive MLM Seeder completed successfully!');
        $this->command->info("Created 200 users with proper sponsor hierarchy and tree repetition");
    ...
    /**
     * Create 500 users with proper binary tree structure
     */
    private function create200UsersWithTreeRepetition($admin, $levelPlans)
    {
        $users = [];
        $userCounter = 1;
        $targetUsers = 500; // Changed to 500 users
        ...
        // Create additional trees under existing users to reach 500 total
        $treeNumber = 2;
        $maxTrees = 100; // Increased limit for 500 users
