...
class BuySlotTreeController extends Controller
{
     ...
     * Web route: GET /tree-display/{id} or /tree-display/{id}/{round}
     * 
     * @param int $id
     * @param int|null $round
     * @return \Illuminate\View\View
     */
    public function displayTree($id, $round = null)
    {
        try {
            // Debug: Log the parameters
            Log::info('displayTree called with id: ' . $id . ', round: ' . ($round ?? 'null'));
            
            // Handle the case where round is not provided
            if ($round === null) {
                Log::info('Round is null, will use first available slot');
            }
            ...
            if ($round === null) {
                // If no round specified, use the first available slot
    ...
    /**
     * Simple tree display method for single parameter
     * Web route: GET /tree-display/{id}
     * 
     * @param int $id
     * @return \Illuminate\View\View
     */
    public function displayTreeSimple($id)
    {
        return $this->displayTree($id, null);
    }
}
